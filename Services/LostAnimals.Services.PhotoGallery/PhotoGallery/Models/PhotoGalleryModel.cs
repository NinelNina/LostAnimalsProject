...
public class PhotoGalleryModelProfile : Profile
{
    ...
    public class PhotoGalleryModelActions : IMappingAction<PhotoGallery, PhotoGalleryModel>
    {
        ...
        public void Process(PhotoGallery source, PhotoGalleryModel destination, ResolutionContext context)
        {
